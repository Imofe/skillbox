...
with open(f'23tema/{file_name}', 'r', encoding='utf8') as f_registration, \
        open(f'23tema/{file_good_name}', 'a', encoding='utf8') as file_good, \
        open(f'23tema/{file_bad_name}', 'a', encoding='utf8') as file_bad:
