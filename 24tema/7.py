...
default_house = House()
default_human_1 = Human('Скали', default_house)
default_human_2 = Human('Милано', default_house)
game.play(default_human_1, default_human_2)

game = Game(365)
house = House(1000, 1000)
human_1 = Human('Скали', house)
human_2 = Human('Милано', house)
game.play(human_1, human_2)

game = Game(365)
zero_house = House(0, 0)
zero_human_1 = Human('Скали', zero_house, 0)
zero_human_2 = Human('Милано', zero_house, 0)
