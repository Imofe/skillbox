class Student:
    ...
    def __init__(self, full_name: str, group: str, progress: tuple):
        self.full_name = full_name
        self.group = group
        self.progress = progress

    def __str__(self):
        return f'ФИО: {self.full_name} Группа: {self.group} Средний балл: {self.get_average()}'
...
list_student = [Student(*acquisition_data()) for _ in range(STUDENTS_COUNT)]
